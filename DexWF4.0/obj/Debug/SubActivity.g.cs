...
namespace DexWF4._0.WorkFlowActivity {
    ...
    public partial class SubActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InArgument<string> _BookMark;
        
        private System.Activities.InArgument<int> _FlowID;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<string> BookMark {
            get {
        ...
        public System.Activities.InArgument<int> FlowID {
            get {
                return this._FlowID;
            }
            set {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SubActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SubActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(SubActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SubActivity.g.xaml") || resource.Equals("SubActivity.g.xaml"))) {
                    return resource;
                }
            }
