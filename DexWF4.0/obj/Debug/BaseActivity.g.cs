...
namespace DexWF4._0.WorkFlowActivity {
    ...
    public partial class BaseActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.InOutArgument<int> _FlowID;
        
        private System.Activities.InArgument<int[]> _BookMarks;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InOutArgument<int> FlowID {
            get {
                return this._FlowID;
            }
            set {
        ...
        public System.Activities.InArgument<int[]> BookMarks {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(BaseActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(BaseActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(BaseActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".BaseActivity.g.xaml") || resource.Equals("BaseActivity.g.xaml"))) {
                    return resource;
                }
            }
